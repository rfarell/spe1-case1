...
with h5py.File('patched/SPE1CASE1_PATCHED.h5', 'r') as f:
    ...
    # Get center cell evolution (5,5,1)
    cx, cy, cz = 5, 5, 1
...
# Plot 1: Pressure evolution at center cell
ax1.plot(dates, pressure_center, 'b-', linewidth=2)
ax1.set_xlabel('Time')
ax1.set_ylabel('Pressure (bar)')
ax1.set_title(f'Pressure Evolution at Cell ({cx},{cy},{cz})')
ax1.grid(True, alpha=0.3)

# Plot 2: Saturation evolution at center cell
...
ax2.set_title(f'Saturation Evolution at Cell ({cx},{cy},{cz})')
ax2.legend()
...
print("Created: time_evolution.png, oil_depletion_snapshots.png")